...
public class SetUpWebdriver {
	...
	public static WebDriver setupWebDriver(String driverType) throws Exception {
		try
		{
        ...
        String LOB="";
  		...
  		if(LOB.equalsIgnoreCase("QuoteCreation")  || LOB.equalsIgnoreCase("Pricing"))
  		{
  			...
  			driver.navigate().to(ConfigReader.getInstance().getValue(PropertyConfigs.GSTNOnlineLogin_Url));
  		}
